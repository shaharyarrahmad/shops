  ...
  <DefaultLayout>
    <!-- PRODUCT CARD -->
      ...
      <section id="popular-categories">
        <h4 class="title has-text-black has-text-weight-bold is-5 pt-5">Populaire categorieën</h4>
      ...
      <section id="popular-products">
        <h4 class="title has-text-black has-text-weight-bold is-5 pt-5">Populaire producten</h4>
        <div class="columns is-multiline is-mobile">
          <template v-for="index in 5">
            <div class="column is-4-mobile is-one-fifth-desktop">
              <ProductCard
