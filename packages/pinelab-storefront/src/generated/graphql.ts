...
export type AdditionalCollectionFieldsFragment = {
  __typename?: 'Collection';
} & Pick<Collection, 'id'>;

export type AdditionalProductFieldsFragment = { __typename?: 'Product' } & Pick<
  Product,
  'id'
>;

export type AdditionalOrderFieldsFragment = { __typename?: 'Order' } & Pick<
  Order,
  'id'
>;
