<template>
  <section v-else id="products">
    ...
    <div
      v-if="$context.collections || $context.collectionName"
    ...
    <div v-if="$context.collection" class="grid-x grid-padding-x">
      <div class="cell text-center">
        ...
        <div
          style="margin-bottom: 20px; font-size: 0.7rem"
    ...
    <div class="grid-x grid-padding-x small-up-2 medium-up-4 large-up-4">
      ...
      <div
        v-if="$context.products && $context.products.length === 0"
        class="small-12"
      >
