<template>
  <div class="container is-max-desktop has-text-centered">
    ...
    <b-steps
      ...
      <b-step-item step="1" icon="account" :clickable="false">
      </b-step-item>
      <b-step-item step="2" icon="truck" :clickable="false">
      </b-step-item>
...
export default {
  props: {
    message: { default: 'This is what you ordered. You will receive a confirmation in your email.' },
