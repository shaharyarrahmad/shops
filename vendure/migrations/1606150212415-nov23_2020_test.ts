...
export class nov232020Test1606150212415 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("DROP INDEX `FK_43ac602f839847fdb91101f30ec` ON `history_entry`", undefined);
        await queryRunner.query("DROP INDEX `FK_3a05127e67435b4d2332ded7c9e` ON `history_entry`", undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE INDEX `FK_3a05127e67435b4d2332ded7c9e` ON `history_entry` (`orderId`)", undefined);
        await queryRunner.query("CREATE INDEX `FK_43ac602f839847fdb91101f30ec` ON `history_entry` (`customerId`)", undefined);
